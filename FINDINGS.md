...
1. **`market.cbr_funding_spread` ([`src/wsf/connectors/cbr.py`](src/wsf/connectors/cbr.py)):**
...
2. **`nav.spatial_warnings` ([`src/wsf/connectors/navarea.py`](src/wsf/connectors/navarea.py)):**
...
3. **`official.gazette_cadence` ([`src/wsf/connectors/gazette_cadence.py`](src/wsf/connectors/gazette_cadence.py)):**
