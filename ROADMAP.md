...
|---|---|---|
| UX-N04 | Done | WSD Intelligence Desk identity in browser title, favicon, mobile navigation and HTML/PDF exports. Shared action sizing and theme-aware primary colours; saved-version download markup corrected. 19 frontend tests/build and 19 targeted Python tests passed; browser inspected 360/390/1280/1920px layouts and dark controls; brief/assessment PDF fixtures rendered and inspected. Full accessibility/contrast qualification remains N06. Existing 16 analyst_workflow.py lint findings unchanged from main. |
