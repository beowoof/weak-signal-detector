...
export default function ReportView({ scenario, noticeId, report, busy, onSave, onDraftChange, machineSeed, evidenceReview, onReset, step: routeStep, onStepChange, onWorkflowChange }) {
